...
parser.add_argument('--input', type=argparse.FileType('r'), help='Input file', required=False)
parser.add_argument('--output', type=argparse.FileType('w'), help='Output file', required=False)
