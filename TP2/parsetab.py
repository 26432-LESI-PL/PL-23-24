...
_lr_productions = [
  ...
  ('statement -> FUNCTION ID LPAREN param_list RPAREN COMMA COLON expression SEMICOLON','statement',9,'p_statement_function_oneliner_declaration','cparser.py',68),
  ('statement -> FUNCTION ID LPAREN RPAREN COMMA COLON expression SEMICOLON','statement',8,'p_statement_function_oneliner_declaration','cparser.py',69),
  ...
  ('param_list -> param_list COMMA ID','param_list',3,'p_param_list','cparser.py',87),
  ('param_list -> ID','param_list',1,'p_param_list','cparser.py',88),
  ('statement -> END','statement',1,'p_statement_end','cparser.py',95),
  ('expression -> ID EQUALS INPUT LPAREN RPAREN','expression',5,'p_expression_input','cparser.py',99),
  ('expression -> ID EQUALS RANDOM LPAREN expression RPAREN','expression',6,'p_expression_random','cparser.py',105),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','cparser.py',111),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','cparser.py',112),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','cparser.py',113),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','cparser.py',114),
  ('expression -> expression CONCAT expression','expression',3,'p_expression_concat','cparser.py',125),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','cparser.py',134),
  ('expression -> STRING','expression',1,'p_expression_string','cparser.py',138),
  ('expression -> NUMBER','expression',1,'p_expression_number','cparser.py',142),
  ('expression -> ID','expression',1,'p_expression_id','cparser.py',146),
]
