...
_lr_productions = [
  ...
  ('list -> LBRACKET elements RBRACKET','list',3,'p_list','cparser.py',68),
  ('list -> LBRACKET RBRACKET','list',2,'p_list','cparser.py',69),
  ('elements -> elements COMMA expression','elements',3,'p_elements','cparser.py',76),
  ('elements -> expression','elements',1,'p_elements','cparser.py',77),
  ('statement -> PRINT LPAREN ID RPAREN SEMICOLON','statement',5,'p_statement_print_list','cparser.py',87),
  ('statement -> PRINT LPAREN STRING RPAREN SEMICOLON','statement',5,'p_statement_print_string','cparser.py',101),
  ('statement -> PRINT LPAREN expression RPAREN SEMICOLON','statement',5,'p_statement_print_expr','cparser.py',116),
  ('statement -> expression SEMICOLON','statement',2,'p_statement_expr','cparser.py',121),
  ('statement -> FUNCTION ID LPAREN param_list RPAREN COMMA COLON expression SEMICOLON','statement',9,'p_statement_function_oneliner_declaration','cparser.py',125),
  ('statement -> FUNCTION ID LPAREN RPAREN COMMA COLON expression SEMICOLON','statement',8,'p_statement_function_oneliner_declaration','cparser.py',126),
  ('statement -> FUNCTION ID LPAREN param_list RPAREN COLON statements END','statement',8,'p_statement_function_declaration','cparser.py',136),
  ('statement -> FUNCTION ID LPAREN RPAREN COLON statements END','statement',7,'p_statement_function_declaration','cparser.py',137),
  ('param_list -> param_list COMMA ID','param_list',3,'p_param_list','cparser.py',163),
  ('param_list -> ID','param_list',1,'p_param_list','cparser.py',164),
  ('statement -> END','statement',1,'p_statement_end','cparser.py',171),
  ('expression -> INPUT LPAREN RPAREN','expression',3,'p_expression_input','cparser.py',176),
  ('expression -> RANDOM LPAREN expression RPAREN','expression',4,'p_expression_random','cparser.py',182),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','cparser.py',188),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','cparser.py',189),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','cparser.py',190),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','cparser.py',191),
  ('expression -> expression CONCAT expression','expression',3,'p_expression_concat','cparser.py',202),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','cparser.py',206),
  ('expression -> STRING','expression',1,'p_expression_string','cparser.py',210),
  ('expression -> NUMBER','expression',1,'p_expression_number','cparser.py',214),
  ('expression -> ID','expression',1,'p_expression_id','cparser.py',218),
  ('expression -> ID LPAREN arg_list RPAREN','expression',4,'p_expression_function_call','cparser.py',222),
  ('arg_list -> arg_list COMMA expression','arg_list',3,'p_arg_list','cparser.py',228),
